      ...
      */}
      ...
      <section id="web">
        ...
        <ul>
          <li>
            <p>
              Front-end design using HTML5/XHTML, JavaScript, React.js, CSS3/SCSS, and
              Photoshop/GIMP.
            </p>
          </li>
      ...
      <section id="software">
        ...
        <ul>
          <li>
            <p>
              Procedural, object-oriented, functional, logic, and shell programming languages
              including C#, C/C++, JavaScript, Ruby, PHP, Python, Scheme/LISP, Haskell, SML, Prolog,
              BASH, GNU Make.
            </p>
          </li>
          <li>
            <p>
              The Microsoft Visual Studio IDE including .NET framework 2/3/4, Windows Forms, WPF,
              and Windows Phone development.
            </p>
          </li>
          <li>
            <p>
              Design patterns and principles including Test-Driven Development, Inversion of
              Control/Dependency Injection, Open/Closed Principle, and Separation of Concerns.
            </p>
          </li>
      ...
      <section id="sys-admin">
        ...
        <ul>
          <li>
            <p>Linux Web server design using Apache, Nginx, PHP/MySQL services, BIND, ISC DHCP.</p>
          </li>
          <li>
            <p>Windows, Mac OS, Ubuntu, iOS, Android, Windows Phone, and Cygwin environments.</p>
          </li>
          ...
          <li>
            <p>
              Routing protocols and other network standards and their implementation in Cisco IOS
              and Linux including RIP, IGRP/EIGRP, OSPF, STP, VTP, VLANs, NAT, DHCP, ACLs, link
              aggregation.
            </p>
          </li>
        </ul>
      ...
      <section id="employment">
        ...
        <section id="emp-code42">
          <section>
            ...
            <ul>
              <li>
                Developed desktop client user interfaces using Web technologies such as Electron,
                JavaScript (ES6), React.js, SCSS, Grunt.
              </li>
              <li>
                Worked closely with Product, UX, and Design to clearly define feature and project
                scope.
              </li>
              <li>
                Responsible for tracking and ensuring completeness and correctness of a major
                component of the application.
              </li>
              <li>
                Developed automated tests using Selenium, Capybara, and Spinach in a full-stack
                environment.
              </li>
            </ul>
          </section>
          <section>
            ...
            <ul>
              <li>
                Developed desktop client user interfaces and the underlying service to support them
                using the .NET Framework and WPF.
              </li>
              <li>Redesigned and maintained build systems using Jenkins and MSBuild.</li>
              <li>
                Implemented and maintained branching strategies and dependency management for the
                project repositories.
              </li>
              <li>
                Developed and coordinated cross-platform automated testing tools for a full-stack
                environment.
              </li>
            </ul>
          </section>
      ...
      <section id="education">
        ...
        <section id="edu-century">
          ...
          <ul>
            <li>
              Associate in Applied Science – Information and Telecommunications Technology
              (Spring 2008)
            </li>
