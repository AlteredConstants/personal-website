    ...
    <article>
      ...
      <MainSection title="About the Person">
        ...
        <p>
          ...
          last decade honing his software development skills, starting from humble HTML websites
          full of <code>&lt;table&gt;</code>s and bad graphics through to complex, modular, testable
          APIs and UIs for Web, desktop, and phone platforms. His primary areas of interest include
          Web frameworks and standards, Natural Language Processing, and formal language design.
        </p>
        <p>
          Beside software, Zeff enjoys recreational cycling and fencing, dabbles in Eastern martial
          arts, and has an undying crush on East Asian culture and history (though not so much
          <em>anime</em> or <em>manga</em>). He has studied the Japanese language for several years
          and has visited Japan, South Korea, and China and is looking forward to returning to the
          region. He also enjoys intellectual debates on subjects such as environmentalism, gender
          identity, politics, and economics (to name a few).
        </p>
      </MainSection>
      ...
      <MainSection title="About the Name">
        ...
        <ol>
          ...
          <li>
            a reference to a track by Boards of Canada, one of my favorite musical groups, called
            "Constants Are Changing" from their 2005 release <cite>The Campfire Headphase</cite>
