		...
		return (
			<div>
				...
				<section id="the-basics">
					...
					<p>At the moment, the best place to contact me is probably Twitter <a href="https://twitter.com/AltConsts">@AltConsts</a>.</p>
					<p>If you've got something private to say, I'll probably have a form for sending emails at some point. Until then, you can try one of the following:</p>
